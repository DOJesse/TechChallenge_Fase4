...
## 📖 Descrição
Esta aplicação é um **Tech Challenge** da Fase 4 do MLET/FIAP que demonstra uma pipeline completa de aprendizado profundo para séries temporais, usando **LSTM** para prever o preço de fechamento de ações. 
